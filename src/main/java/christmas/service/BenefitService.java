...
public class BenefitService {
    ...
    public Benefit calculateBenefit(OrderSheet orderSheet) {
        ...
        int christMasDDayDiscountPrice = orderSheet.calculateChristMasDDayDiscount();
        ...
        return new Benefit(hasGiveAway, christMasDDayDiscountPrice, weekDiscountPrice, specialDiscountPrice, badge);
    }
